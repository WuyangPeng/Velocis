...
{
public sealed partial class title_config : Luban.BeanBase
{
    public title_config(ByteBuf _buf) 
    {
    ...
    public static title_config Deserializetitle_config(ByteBuf _buf)
    {
        return new game.title_config(_buf);
    }
    ...
    public const int __ID__ = 1074652037;
