...
namespace Game.Scripts.Main.Editor.Protobuf
{
    public class HandlerGeneratorInstance
    {
        ...
        private void GenerateHandlerForMessage(ProtoMessage message)
        {
            ...
            {
                foreach (var field in message.Fields.Where(f => !string.IsNullOrEmpty(f.OneOfGroup)))
                {
            ...
            if (message.OneOfs.Count == 1)
            {
                ...
                foreach (var field in message.Fields.Where(f => f.OneOfGroup == oneOfGroup))
                {
        ...
        {
            if (string.IsNullOrEmpty(protoPackage)) return "Celeritas.Proto";
