...
namespace Game.Scripts.Main.Runtime.Network.Packet
{
    ...
    public class CSCeleritas : CSPacketBase
    {
        ...
        public activate_item_request Mutable_ClientPlayer_ClientItem_ActivateItem()
        {
            Mutable_ClientPlayer_ClientItem();
            Celeritas.CeleritasRequest.Client.Player.Item.ActivateItem = new activate_item_request();

            return Celeritas.CeleritasRequest.Client.Player.Item.ActivateItem;
        }

        public lock_item_request Mutable_ClientPlayer_ClientItem_LockItem()
        {
            Mutable_ClientPlayer_ClientItem();
            Celeritas.CeleritasRequest.Client.Player.Item.LockItem = new lock_item_request();

            return Celeritas.CeleritasRequest.Client.Player.Item.LockItem;
        }
