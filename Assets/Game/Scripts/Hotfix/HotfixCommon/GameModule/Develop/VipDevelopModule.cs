...
namespace Game.Scripts.Hotfix.HotfixCommon.GameModule.Develop
{
    ...
    public class VipDevelopModule : DevelopModule
    {
        ...
        public void AddItem(DevelopData item, bool isLogin)
        {
            ...
            if (!isLogin)
            {
                GameEntry.Event.Fire(this, ChangeDevelopLevelEventArgs.Create(develop_system_type.vip));
            }
        }
        ...
        /// 删除指定实例的VIP养成数据。
        /// </summary>
        /// <param name="instanceId">VIP数据实例ID。</param>
        ...
        /// 获取VIP当前养成等级。
        /// </summary>
        /// <returns>VIP的当前等级，如无数据则返回 0。</returns>
        public int GetLevel()
        {
