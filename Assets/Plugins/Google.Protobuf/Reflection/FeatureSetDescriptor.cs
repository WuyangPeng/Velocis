...
namespace Google.Protobuf.Reflection
{
    ...
    internal sealed partial class FeatureSetDescriptor
    {
        ...
        private static readonly IReadOnlyDictionary<Edition, FeatureSetDescriptor> descriptorsByEdition =
            BuildEditionDefaults();
        ...
        private static IReadOnlyDictionary<Edition, FeatureSetDescriptor> BuildEditionDefaults()
        {
            ...
            FeatureSetDescriptor MaybeCreateDescriptor(Edition edition)
            {
                ...
                if (editionDefaults is null) return null;
        ...
        {
            return descriptorsByEdition.TryGetValue(edition, out var defaults)
                ? defaults
        ...
        ///     The proto representation of the "child" feature set to merge with this
        ///     one. May be null, in which case this descriptor is returned.
        /// </param>
